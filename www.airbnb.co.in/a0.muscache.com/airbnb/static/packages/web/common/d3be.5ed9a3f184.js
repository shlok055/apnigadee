...
__d((function(g, r, i, a, m, e, d) {
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        e: {
            ...
            if (!c ? .title) {
                let t;
                p[0] !== o ? (t = (0, n.camelKeysToSnakeKeys)(o), p[0] = o, p[1] = t) : t = p[1], s = t;
                break e
            }
            if ("StayEmbedData" === o.__typename) {
                let t;
                p[2] !== o || p[3] !== c.title ? (t = (0, n.camelKeysToSnakeKeys)(l(o, c.title)), p[2] = o, p[3] = c.title, p[4] = t) : t = p[4], s = t;
                break e
            }
            if ("ExperienceEmbedData" === o.__typename) {
                let t;
                p[5] !== o || p[6] !== c.title ? (t = (0, n.camelKeysToSnakeKeys)(y(o, c.title)), p[5] = o, p[6] = c.title, p[7] = t) : t = p[7], s = t;
                break e
            }
            let t;p[8] !== o ? (t = (0, n.camelKeysToSnakeKeys)(o), p[8] = o, p[9] = t) : t = p[9],
            s = t
        }
        return s
    };
...
__d((function(g, r, i, a, m, e, d) {
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        const u = Object.entries(t).reduce(((t, [u, c]) => ({ ...t,
            [u]: c.default
        })), {});
        return u['@supports(--custom: properties)'] = Object.entries(t).reduce(((t, [u, c]) => ({ ...t,
            [u]: c.property ? `var(${c.property}, ${c.default})` : c.default
        })), {}), u
    }
}), "ea81db", []);
__d((function(g, r, i, a, m, e, d) {
...
//# sourceMappingURL=https://sourcemaps.d.musta.ch/airbnb/static/packages/web/common/d3be.51909cfb9a.js.map
/*1738392830,,JIT Construction: v1019763079,en_GB*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/en_GB\/sdk.js",
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._( /*BTDS*/ "Cancel") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._( /*BTDS*/ "Cancel") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._( /*BTDS*/ "Loading...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return o.create({
                    ...
                    function v(a, b, d, e) {
                        ...
                        for (var n = 0; n < m.length; n++) {
                            var s = f[m[n]],
                                ...
                                u = babelHelpers["extends"]({}, g);
                            if (s.execute(a, b, u, e, t)) return
                        }
                        e({
                            error: {
                                type: "no-transport",
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Auth.LoginStatus", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f, g) {
                    ...
                    function k(a) {
                        ...
                        if (c("sdk.Auth").getAuthResponse() && !a.params.scope && !a.params.config_id && !a.params.asset_scope && !a.params.auth_type) {
                        ...
                        iframe: function(a) {
                            ...
                            var b = function() {
                                    var b = ES("JSON", "stringify", !1, {
                                        error_code: 4201,
                                        error_message: c("sdk.fbt")._( /*BTDS*/ "User canceled the Dialog flow")
                                    });
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._( /*BTDS*/ "Continue With {facebook_app_name} or {instagram_app_name}"),
                        continueWithShort: a._( /*BTDS*/ "{facebook_app_name} or {instagram_app_name}"),
                        loginButtonAriaLabel: a._( /*BTDS*/ "Continue with Facebook or Instagram"),
                        logout: a._( /*BTDS*/ "Log Out"),
                        logoutButtonAriaLabel: a._( /*BTDS*/ "Log out of the current website"),
                        titleText: a._( /*BTDS*/ "Choose account"),
                        promptText: a._( /*BTDS*/ "Which account would you like to use to log in?"),
                        facebookText: a._( /*BTDS*/ "Log in With Facebook"),
                        facebookTextShort: a._( /*BTDS*/ "Log in"),
                        instagramText: a._( /*BTDS*/ "Log in With Instagram"),
                        disambiguationDialogAriaLabelText: a._( /*BTDS*/ "Log in with Facebook or Instagram"),
                        fbButtonText: a._( /*BTDS*/ "Continue with Facebook"),
                        igButtonText: a._( /*BTDS*/ "Continue with Instagram")
                    };
                ...
                __d("sdk.CustomTags", ["sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.MessengerCheckboxWrapper", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video"], (function(a, b, c, d, e, f) {
                    "use strict";
                    a = {
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    var h = function() {
                        function a(a) {
                            ...
                            e.textContent = c("sdk.fbt")._( /*BTDS*/ "Share to Facebook");
    ...
    __fb_i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + __fb_err.name + '","line":"' + (__fb_err.lineNumber || __fb_err.line) + '","script":"' + (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "sdk.js") + '","stack":"' + (__fb_err.stackTrace || __fb_err.stack) + '","revision":"1019763079","namespace":"FB","message":"' + __fb_err.message + '"}}');
